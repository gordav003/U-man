...
def draw_scatter(
    ...
    axes[0].set_xlabel("Q/MVAr", fontsize=16, fontweight="bold", labelpad=10)
    axes[0].set_ylabel("U/kV", fontsize=16, fontweight="bold", labelpad=10)
    ...
    axes[1].set_xlabel("dQ/MVAr", fontsize=16, fontweight="bold", labelpad=10)
    axes[1].set_ylabel("dU/kV", fontsize=16, fontweight="bold", labelpad=10)
